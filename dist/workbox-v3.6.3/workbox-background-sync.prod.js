(this.workbox = this.workbox || {}),
  (this.workbox.backgroundSync = (function(e, t) {
    ...
    class s {
      ...
      constructor({ url: e, requestInit: t, timestamp: r = Date.now() }) {
      ...
      clone() {
        ...
        return (
          (e.headers = Object.assign({}, this.requestInit.headers)),
          this.requestInit.body && (e.body = this.requestInit.body.slice()),
          new s({ url: this.url, timestamp: this.timestamp, requestInit: e })
        );
      }
    }
    ...
    class l {
      ...
      addEntry(e) {
        var t = this;
        return babelHelpers.asyncToGenerator(function*() {
          yield t.r.add(n, { queueName: t.t.name, storableRequest: e.toObject() });
        })();
      }
    ...
    class h {
      constructor(e, { callbacks: r = {}, maxRetentionTime: s = o } = {}) {
        if (a.has(e)) throw new t.WorkboxError('duplicate-queue-name', { name: e });
      ...
      replayRequests() {
        ...
        return babelHelpers.asyncToGenerator(function*() {
          ...
          if ((yield e.o('queueDidReplay', s), i.length))
            ...
            new t.WorkboxError('queue-replay-failed', { name: e.s, count: i.length }));
        })();
      }
      o(e, ...t) {
        var r = this;
