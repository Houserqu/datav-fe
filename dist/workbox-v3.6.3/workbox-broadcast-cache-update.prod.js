  ...
  (this.workbox.broadcastUpdate = (function(t) {
    ...
    const a = (t, e, a, n) => {
      'BroadcastChannel' in self &&
        t &&
        t.postMessage({ type: s.CACHE_UPDATED, meta: n, payload: { cacheName: e, updatedUrl: a } });
    };
    class n {
      ...
      a() {
        return (
          'BroadcastChannel' in self && !this.n && (this.n = new BroadcastChannel(this.t)), this.n
        );
      }
    ...
    return (
      ...
      (t.Plugin = class {
        ...
        cacheDidUpdate({ cacheName: t, oldResponse: e, newResponse: s, request: a }) {
