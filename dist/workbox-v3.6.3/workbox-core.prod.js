  ...
  (this.workbox.core = (function() {
    ...
    const n = e => r <= e,
      ...
      l = function(r, o, i) {
        ...
        const s = [
          '%cworkbox',
          `background: ${i}; color: white; padding: 2px 0.5em; ` + 'border-radius: 0.5em;',
        ];
        console[r](...s, ...o);
      },
      s = () => {
    ...
    const g = new Set();
    class v {
      constructor(e, t, { onupgradeneeded: r, onversionchange: n = this.e } = {}) {
    ...
    const P = ((W = babelHelpers.asyncToGenerator(function*({
      ...
      let o = t,
        i = !1;
      for (let t of n)
        if (L in t && ((i = !0), !(o = yield t[L].call(t, { request: e, response: o, event: r }))))
          break;
      ...
      _ = {
        fetch: (() => {
          var e = babelHelpers.asyncToGenerator(function*({
            ...
            try {
              for (let t of n) N in t && (e = yield t[N].call(t, { request: e.clone(), event: r }));
            } catch (e) {
