(this.workbox = this.workbox || {}),
  (this.workbox.routing = (function(t, e) {
    ...
    class i {
      ...
      handleRequest(t) {
        ...
        let r = null,
          ...
          n = null;
        const o = this.e(t, e);
        if (((s = o.handler), (n = o.params), (r = o.route), !s && this.r && (s = this.r), !s))
          return;
        let i;
        try {
        ...
        return i && this.s && (i = i.catch(r => this.s.handle({ url: e, event: t, err: r }))), i;
      }
      e(t, e) {
          ...
          if (r)
            return (
              Array.isArray(r) && 0 === r.length
                ? (r = void 0)
                : ((r.constructor === Object && 0 === Object.keys(r).length) || !0 === r) &&
                  (r = void 0),
      ...
      unregisterRoute(e) {
        if (!this.t.has(e.method))
          throw new t.WorkboxError('unregister-route-but-not-found-with-method', {
            method: e.method,
          });
    ...
    var a = Object.freeze({ RegExpRoute: o, Route: n, Router: i, NavigationRoute: u });
